    ...
    <div class="wrap">
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    <td colspan="2">
                        <p>Use the <strong>[team_members_nd]</strong> shortcode to display the team members grid on any page
                            or post.</p>
                ...
                <tr valign="top">
                    ...
                    <td><input type="text" name="text_color_nd" value="<?php echo esc_attr(get_option('text_color_nd')); ?>"
                            class="team-members-color-picker" /></td>
                </tr>
                <tr valign="top">
                    <th scope="row">Background Color</th>
                    <td><input type="text" name="background_color_nd"
                            value="<?php echo esc_attr(get_option('background_color_nd')); ?>"
                            class="team-members-color-picker" /></td>
                </tr>
                <tr valign="top">
                    <th scope="row">Border Color</th>
                    <td><input type="text" name="border_color_nd"
                            value="<?php echo esc_attr(get_option('border_color_nd')); ?>"
                            class="team-members-color-picker" /></td>
                </tr>
                <tr valign="top">
                    <th scope="row">Border Radius</th>
                    <td><input type="text" name="border_radius_nd"
                            value="<?php echo esc_attr(get_option('border_radius_nd')); ?>" placeholder="5px" /></td>
                </tr>
                <tr valign="top">
                    <th scope="row">Padding</th>
                    <td><input type="text" name="padding_nd" value="<?php echo esc_attr(get_option('padding_nd')); ?>"
                            placeholder="10px" /></td>
                </tr>
                <tr valign="top">
                    <th scope="row">Margin</th>
                    <td><input type="text" name="margin_nd" value="<?php echo esc_attr(get_option('margin_nd')); ?>"
                            placeholder="10px" /></td>
                </tr>
                ...
                <tr valign="top">
                    ...
                    <td><input type="text" name="image_border_radius_nd"
                            value="<?php echo esc_attr(get_option('image_border_radius_nd', '5px')); ?>"
                            placeholder="5px" /></td>
                </tr>
                ...
                <tr valign="top">
                    ...
                    <td><input type="text" name="title_color_nd"
                            value="<?php echo esc_attr(get_option('title_color_nd')); ?>"
                            class="team-members-color-picker" /></td>
                </tr>
                <tr valign="top">
                    <th scope="row">Title Font Size</th>
                    <td><input type="text" name="title_font_size_nd"
                            value="<?php echo esc_attr(get_option('title_font_size_nd')); ?>" placeholder="24px" /></td>
                </tr>
                <tr valign="top">
                    <th scope="row">Position Color</th>
                    <td><input type="text" name="position_color_nd"
                            value="<?php echo esc_attr(get_option('position_color_nd')); ?>"
                            class="team-members-color-picker" /></td>
                </tr>
                <tr valign="top">
                    <th scope="row">Position Font Size</th>
                    <td><input type="text" name="position_font_size_nd"
                            value="<?php echo esc_attr(get_option('position_font_size_nd')); ?>" placeholder="18px" />
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row">Description Color</th>
                    <td><input type="text" name="description_color_nd"
                            value="<?php echo esc_attr(get_option('description_color_nd')); ?>"
                            class="team-members-color-picker" /></td>
                </tr>
                <tr valign="top">
                    <th scope="row">Description Font Size</th>
                    <td><input type="text" name="description_font_size_nd"
                            value="<?php echo esc_attr(get_option('description_font_size_nd')); ?>" placeholder="16px" />
                    </td>
                </tr>
                ...
                <tr valign="top">
                    ...
                    <td><input type="text" name="detail_padding_nd"
                            value="<?php echo esc_attr(get_option('detail_padding_nd')); ?>" placeholder="20px" /></td>
                </tr>
                <tr valign="top">
                    <th scope="row">Detail Pane Margin</th>
                    <td><input type="text" name="detail_margin_nd"
                            value="<?php echo esc_attr(get_option('detail_margin_nd')); ?>" placeholder="20px" /></td>
                </tr>

                <!-- Icon Settings -->
                <tr valign="top">
                    <th scope="row">Icon Color</th>
                    <td><input type="text" name="icon_color_nd" value="<?php echo esc_attr(get_option('icon_color_nd')); ?>"
                            class="team-members-color-picker" /></td>
                </tr>
                <tr valign="top">
                    <th scope="row">Icon Background Color</th>
                    <td><input type="text" name="icon_background_color_nd"
                            value="<?php echo esc_attr(get_option('icon_background_color_nd')); ?>"
                            class="team-members-color-picker" /></td>
                </tr>
                <tr valign="top">
                    <th scope="row">Icon Border Color</th>
                    <td><input type="text" name="icon_border_color_nd"
                            value="<?php echo esc_attr(get_option('icon_border_color_nd')); ?>"
                            class="team-members-color-picker" /></td>
                </tr>
                <tr valign="top">
                    <th scope="row">Icon Border Radius</th>
                    <td><input type="text" name="icon_border_radius_nd"
                            value="<?php echo esc_attr(get_option('icon_border_radius_nd')); ?>" placeholder="50%" /></td>
                </tr>
                <tr valign="top">
                    <th scope="row">Icon Size</th>
                    <td><input type="text" name="icon_size_nd" value="<?php echo esc_attr(get_option('icon_size_nd')); ?>"
                            placeholder="24px" /></td>
                </tr>
                <tr valign="top">
                    <th scope="row">Icon Padding</th>
                    <td><input type="text" name="icon_padding_nd"
                            value="<?php echo esc_attr(get_option('icon_padding_nd')); ?>" placeholder="5px" /></td>
                </tr>

                <!-- Responsive Breakpoints -->
                <tr valign="top">
                    <th scope="row">Tablet Breakpoint (px)</th>
                    <td><input type="number" name="tablet_breakpoint_nd"
                            value="<?php echo esc_attr(get_option('tablet_breakpoint_nd', 1024)); ?>" placeholder="1024" />
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row">Mobile Breakpoint (px)</th>
                    <td><input type="number" name="mobile_breakpoint_nd"
                            value="<?php echo esc_attr(get_option('mobile_breakpoint_nd', 767)); ?>" placeholder="767" />
                    </td>
                </tr>
            </table>
            <?php submit_button(); ?>
...
function team_members_nd_shortcode()
{
    ...
    if ($team_query->have_posts()):
        ...
        while ($team_query->have_posts()):
            ...
            echo '<div class="image-container-nd" style="border-radius: ' . esc_attr(get_option('image_border_radius_nd', '5px')) . ';">';
            echo '<img src="' . esc_url($picture) . '" alt="' . esc_attr($name) . '">';
            echo '</div>'; // Close image-container-nd
